...
- do not change vmbr0, VM100 networking, Omada routing, VLANs, DNS, DHCP, firewall, VPN, Twingate, or Proxmox configuration as an incidental app change;
...
Use docs/codex/NEXT_STEPS.md as the ordered build queue. Continue from the highest-priority unfinished item that can be verified in the current environment. The next product milestone is Local Agent Platform Phase 1 network validation and live acceptance, not execution features.
