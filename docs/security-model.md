...
- CT108 Ollama: GPU-backed local provider at verified nic1 `10.1.10.12:11434`; `192.168.1.70:11434` is a legacy vmbr0 rollback reference. Its firewall should permit access only from VM102.
