...
Profiles resolve to **Ollama only** in Phase 1. The checked-in VM102 examples use CT108's verified nic1 endpoint (`10.1.10.12:11434`) and `qwen3:4b-instruct`; VM102 passed TCP/11434, `/api/tags`, and `/api/chat` over vmbr1.
